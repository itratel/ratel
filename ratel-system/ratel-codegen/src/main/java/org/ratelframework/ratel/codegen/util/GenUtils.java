package org.ratelframework.ratel.codegen.util;
...
import org.ratelframework.ratel.codegen.entity.ColumnEntity;
import org.ratelframework.ratel.codegen.entity.GenConfig;
import org.ratelframework.ratel.codegen.entity.TableEntity;
import org.ratelframework.ratel.common.core.constant.CommonConstants;
import org.ratelframework.ratel.common.core.exception.CheckedException;
...
public class GenUtils {
	...
	private String getFileName(String template, String className, String packageName, String moduleName) {
		...
		if (template.contains(ENTITY_JAVA_VM)) {
			return packagePath + "org/ratelframework/ratel/codegen/entity" + File.separator + className + ".java";
		}

		if (template.contains(MAPPER_JAVA_VM)) {
			return packagePath + "org/ratelframework/ratel/codegen/mapper" + File.separator + className + "Mapper.java";
		}

		if (template.contains(SERVICE_JAVA_VM)) {
			return packagePath + "org/ratelframework/ratel/codegen/service" + File.separator + className + "Service.java";
		}

		if (template.contains(SERVICE_IMPL_JAVA_VM)) {
			return packagePath + "org/ratelframework/ratel/codegen/service" + File.separator + "impl" + File.separator + className + "ServiceImpl.java";
		}

		if (template.contains(CONTROLLER_JAVA_VM)) {
			return packagePath + "org/ratelframework/ratel/codegen/controller" + File.separator + className + "Controller.java";
		}

		if (template.contains(MAPPER_XML_VM)) {
			return CommonConstants.BACK_END_PROJECT + File.separator + "src" + File.separator + "main" + File.separator + "resources" + File.separator + "org/ratelframework/ratel/codegen/mapper" + File.separator + className + "Mapper.xml";
		}
